          ...
          <table style={{ 
            ...
            <thead>
              <tr style={{ backgroundColor: '#f2f2f2', textAlign: 'left' }}>
                ...
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Generated Date</th>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  <td style={{ padding: '12px' }}>R-0000001</td>
                  <td style={{ padding: '12px' }}>Patient Visit Summary</td>
                  <td style={{ padding: '12px' }}>2024-09-01</td>
                  <td style={{ padding: '12px', color: '#4CAF50' }}>Completed</td>
