  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '20px', fontSize: '30px', color: "#0B8769", marginLeft: '50px' }}>FINANCIAL ASSISTANCE</h2>
          ...
          <table style={{ 
            ...
            <thead>
              <tr style={{ backgroundColor: '#f2f2f2', textAlign: 'left' }}>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Request ID</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Full Name</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Assistance Type</th>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <td style={{ padding: '12px' }}>Financial Aid</td>
