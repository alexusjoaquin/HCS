  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '20px', fontSize: '30px', color: "#0B8769", marginLeft: '50px' }}>BENEFITS WITH PENSION</h2>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <td style={{ padding: '12px' }}>Medical Subsidy</td>
                  <td style={{ padding: '12px' }}>Financial aid for medical expenses for eligible pensioners.</td>
                  <td style={{ padding: '12px' }}>With pension</td>
