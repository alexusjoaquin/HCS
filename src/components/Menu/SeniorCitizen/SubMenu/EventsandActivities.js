  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '20px', fontSize: '30px', color: "#0B8769", marginLeft: '50px' }}>SENIOR CITIZEN EVENTS & ACTIVITIES</h2>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <td style={{ padding: '12px' }}>Yoga Class</td>
                  <td style={{ padding: '12px' }}>2024-09-15</td>
                  <td style={{ padding: '12px' }}>Community Center</td>
