  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '20px', fontSize: '30px', color: "#0B8769", marginLeft: '50px' }}>SENIOR CITIZEN DATA</h2>
          ...
          <table style={{ 
            ...
            <thead>
              <tr style={{ backgroundColor: '#f2f2f2', textAlign: 'left' }}>
                ...
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Pension Status</th>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <td style={{ padding: '12px' }}>1945-03-22</td>
                  <td style={{ padding: '12px' }}>Manila</td>
                  <td style={{ padding: '12px' }}>{index % 2 === 0 ? 'With Pension' : 'Without Pension'}</td>
