...
const CourtcasesModal = ({ isOpen, onClose, onSubmit }) => {
  // Generate an auto-incremented CaseID based on timestamp
  ...
  const handleSubmit = async (e) => {
    ...
    // Reset form with a new CaseID after successful submission
    setFormData({
...
export default CourtcasesModal;
