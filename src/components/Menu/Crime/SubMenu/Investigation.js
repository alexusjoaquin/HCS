  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '20px', fontSize: '30px', color: "#0B8769", marginLeft: '50px' }}>INVESTIGATION</h2>
          ...
          <table style={{ 
            ...
            <thead>
              <tr style={{ backgroundColor: '#f2f2f2', textAlign: 'left' }}>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Investigation ID</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Case Title</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Investigator</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Status</th>
                <th style={{ padding: '12px', borderBottom: '1px solid #ddd' }}>Date Opened</th>
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                  <td style={{ padding: '12px' }}>INV-000001</td>
                  <td style={{ padding: '12px' }}>Burglary at 123 Main St</td>
                  <td style={{ padding: '12px' }}>Detective John Doe</td>
